      ...
      <div>
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="lg:text-center">
            ...
            >
              Join Stem Connect Africa
            </p>
            <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              From Science, Technology, Engineering and Mathematics we have the
              talent that will help you solve your problems
            </p>
          </div>
            ...
            >
              <div class="flex">
                <div class="flex-shrink-0">
                  <div
                    class="flex items-center justify-center h-12 w-12 rounded-md bg-emerald-500 text-white"
                  >
